...
function injectStyles() {
  ...
  style.textContent = `
    ...
    .theme-switcher-label{font-family:'DM Mono',monospace;font-size:8px;letter-spacing:0.1em;text-transform:uppercase;color:rgba(var(--ink-light-rgb),0.4)}
    .theme-switcher-btn{all:unset;cursor:pointer;font-family:'DM Mono',monospace;font-size:9px;letter-spacing:0.06em;text-transform:uppercase;color:rgba(var(--ink-light-rgb),0.55);padding:3px 7px;border-radius:2px;transition:color 0.2s ease,background 0.2s ease}
